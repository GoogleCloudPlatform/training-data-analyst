...
ALLFLIGHTS = LOAD 'gs://cloud-training-demos/flights/201501.csv' using org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'NO_MULTILINE', 'NOCHANGE', 'SKIP_INPUT_HEADER')
