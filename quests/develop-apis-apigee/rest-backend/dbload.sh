...
curl -H "Authorization: Bearer $(gcloud auth print-identity-token)" -H "Content-Type:application/json" -X POST ${SVCHOST}/atms -d '{ "name": "nyc-hudson", "latitude": 40.727722, "longitude": -74.007806 }'
