...
# TASK 2: Add imports for testing.
...
class ConvertToWeatherRecordTest(unittest.TestCase):
    ...
    def test_convert_to_csv(self):
        ...
        with TestPipeline() as p:
            ...
            input_lines = p | # TASK 3: Create PCollection from LINES

            output = input_lines | beam.ParDo(ConvertCsvToWeatherRecord())

            # TASK 3: Write assert_that statement

# TASK 4: Uncomment the following test.
...
# TASK 5: Uncomment the remaining tests.
