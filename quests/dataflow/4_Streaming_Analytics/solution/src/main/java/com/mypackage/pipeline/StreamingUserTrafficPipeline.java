...
/**
 * The {@link StreamingUserTrafficPipeline} is a sample pipeline which can be used as a base for creating a real
 * Dataflow pipeline.
 *
 ...
 * -Dexec.mainClass=com.mypackage.pipeline.StreamingUserTrafficPipeline \
 ...
 * </pre>
 */
public class StreamingUserTrafficPipeline {
   ...
   */
  private static final Logger LOG = LoggerFactory.getLogger(StreamingUserTrafficPipeline.class);
  ...
  public interface Options extends PipelineOptions, StreamingOptions {
    ...
    @Description("Window allowed lateness, in seconds")
  ...
  public static class AggregatePageviews extends
    ...
    public PCollection<Long> expand(PCollection<CommonLog> input) {
      return input
              .apply("WindowByMinute", Window.<CommonLog>into(FixedWindows
                      .of(Duration.standardSeconds(options.getWindowDuration()))))
              // TODO: add allowedlateness, trigger
   ...
   * StreamingUserTrafficPipeline#run(Options)} method to start the pipeline and invoke
