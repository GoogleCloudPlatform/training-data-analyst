...
public class BatchUserTrafficPipeline {
    ...
    public static PipelineResult run(Options options) {
        ...
        pipeline
                ...
                .apply("HitsPerUser", Group.<CommonLog>byFieldNames("user_id")
                ...
                .apply(Select.fieldNames("key.user_id", "value.pageviews", "value.total_bytes", "value.max_num_bytes", "min_num_bytes"))
                .apply("WriteToBQ",
