...
from(select *
     from (select item_sk,rank() over (order by rank_col asc) rnk
           from (select ss_item_sk item_sk,avg(ss_net_profit) rank_col 
                 from tpcds_2t_flat_part_clust.store_sales ss1
...
tpcds_2t_flat_part_clust.item i1,
tpcds_2t_flat_part_clust.item i2
...
(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
 ...
 from(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
      ...
      from tpcds_2t_flat_part_clust.inventory
          ,tpcds_2t_flat_part_clust.item
          ,tpcds_2t_flat_part_clust.warehouse
          ,tpcds_2t_flat_part_clust.date_dim
...
with ssr as
 (select  s_store_id as store_id,
  ...
  from tpcds_2t_flat_part_clust.store_sales left outer join tpcds_2t_flat_part_clust.store_returns on
         (ss_item_sk = sr_item_sk and ss_ticket_number = sr_ticket_number),
     tpcds_2t_flat_part_clust.date_dim,
     tpcds_2t_flat_part_clust.store,
     tpcds_2t_flat_part_clust.item,
     tpcds_2t_flat_part_clust.promotion
 ...
 (select  cp_catalog_page_id as catalog_page_id,
  ...
  from tpcds_2t_flat_part_clust.catalog_sales left outer join tpcds_2t_flat_part_clust.catalog_returns on
         (cs_item_sk = cr_item_sk and cs_order_number = cr_order_number),
     tpcds_2t_flat_part_clust.date_dim,
     tpcds_2t_flat_part_clust.catalog_page,
     tpcds_2t_flat_part_clust.item,
     tpcds_2t_flat_part_clust.promotion
...
group by cp_catalog_page_id)
 ...
 (select  web_site_id,
  ...
  from tpcds_2t_flat_part_clust.web_sales left outer join tpcds_2t_flat_part_clust.web_returns on
         (ws_item_sk = wr_item_sk and ws_order_number = wr_order_number),
     tpcds_2t_flat_part_clust.date_dim,
     tpcds_2t_flat_part_clust.web_site,
     tpcds_2t_flat_part_clust.item,
     tpcds_2t_flat_part_clust.promotion
...
from 
   tpcds_2t_flat_part_clust.catalog_sales 
   ,tpcds_2t_flat_part_clust.item 
   ,tpcds_2t_flat_part_clust.date_dim
where
i_manufact_id = 283
...
select  i_brand_id brand_id, i_brand brand, i_manufact_id, i_manufact,
 ...
 from tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.item,tpcds_2t_flat_part_clust.customer,tpcds_2t_flat_part_clust.customer_address,tpcds_2t_flat_part_clust.store
...
select  
 ...
 from
 tpcds_2t_flat_part_clust.store_sales
 ,tpcds_2t_flat_part_clust.store_returns
 ,tpcds_2t_flat_part_clust.catalog_sales
 ,tpcds_2t_flat_part_clust.date_dim d1
 ,tpcds_2t_flat_part_clust.date_dim d2
 ,tpcds_2t_flat_part_clust.date_dim d3
 ,tpcds_2t_flat_part_clust.store
 ,tpcds_2t_flat_part_clust.item
 where
 d1.d_moy = 4
...
with ws as
  (select d_year AS ws_sold_year, ws_item_sk,
   ...
   from tpcds_2t_flat_part_clust.web_sales
   left join tpcds_2t_flat_part_clust.web_returns on wr_order_number=ws_order_number and ws_item_sk=wr_item_sk
   join tpcds_2t_flat_part_clust.date_dim on ws_sold_date_sk = d_date_sk
...
cs as
  (select d_year AS cs_sold_year, cs_item_sk,
   ...
   from tpcds_2t_flat_part_clust.catalog_sales
   left join tpcds_2t_flat_part_clust.catalog_returns on cr_order_number=cs_order_number and cs_item_sk=cr_item_sk
   join tpcds_2t_flat_part_clust.date_dim on cs_sold_date_sk = d_date_sk
...
ss as
  (select d_year AS ss_sold_year, ss_item_sk,
   ...
   from tpcds_2t_flat_part_clust.store_sales
   left join tpcds_2t_flat_part_clust.store_returns on sr_ticket_number=ss_ticket_number and ss_item_sk=sr_item_sk
   join tpcds_2t_flat_part_clust.date_dim on ss_sold_date_sk = d_date_sk
...
select   
 ...
 from
    tpcds_2t_flat_part_clust.web_sales
   ,tpcds_2t_flat_part_clust.date_dim       d1
   ,tpcds_2t_flat_part_clust.item
 where
...
from tpcds_2t_flat_part_clust.store_returns
,tpcds_2t_flat_part_clust.date_dim
...
,tpcds_2t_flat_part_clust.store
,tpcds_2t_flat_part_clust.customer
...
from
        tpcds_2t_flat_part_clust.call_center,
        tpcds_2t_flat_part_clust.catalog_returns,
        tpcds_2t_flat_part_clust.date_dim,
        tpcds_2t_flat_part_clust.customer,
        tpcds_2t_flat_part_clust.customer_address,
        tpcds_2t_flat_part_clust.customer_demographics,
        tpcds_2t_flat_part_clust.household_demographics
where
...
select  s_store_name, s_store_id,
 ...
 from tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.store
...
select  i_item_id,
        ...
        avg(ss_coupon_amt) agg3,
        avg(ss_sales_price) agg4
 from tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.customer_demographics, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store, tpcds_2t_flat_part_clust.item
 where ss_sold_date_sk = d_date_sk and
       ss_item_sk = i_item_sk and
...
from
   tpcds_2t_flat_part_clust.web_sales ws1
  ,tpcds_2t_flat_part_clust.date_dim
  ,tpcds_2t_flat_part_clust.customer_address
  ,tpcds_2t_flat_part_clust.web_site
where
...
and exists (select *
            from tpcds_2t_flat_part_clust.web_sales ws2
            where ws1.ws_order_number = ws2.ws_order_number
              and ws1.ws_warehouse_sk <> ws2.ws_warehouse_sk)
and not exists(select *
               from tpcds_2t_flat_part_clust.web_returns wr1
...
select  ca_zip, ca_county, sum(ws_sales_price)
 from tpcds_2t_flat_part_clust.web_sales, tpcds_2t_flat_part_clust.customer, tpcds_2t_flat_part_clust.customer_address, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.item
 where ws_bill_customer_sk = c_customer_sk
 	...
 	and ( substr(ca_zip,1,5) in ('85669', '86197','88274','83405','86475', '85392', '85460', '80348', '81792')
 	      ...
 	      i_item_id in (select i_item_id
                             from tpcds_2t_flat_part_clust.item
...
cross_sales as
 (select i_product_name product_name
  ...
  FROM   tpcds_2t_flat_part_clust.store_sales
        ...
        ,tpcds_2t_flat_part_clust.store
        ,tpcds_2t_flat_part_clust.customer
        ,tpcds_2t_flat_part_clust.customer_demographics cd1
        ,tpcds_2t_flat_part_clust.customer_demographics cd2
        ,tpcds_2t_flat_part_clust.promotion
        ,tpcds_2t_flat_part_clust.household_demographics hd1
        ,tpcds_2t_flat_part_clust.household_demographics hd2
        ,tpcds_2t_flat_part_clust.customer_address ad1
        ,tpcds_2t_flat_part_clust.customer_address ad2
        ,tpcds_2t_flat_part_clust.income_band ib1
        ,tpcds_2t_flat_part_clust.income_band ib2
        ,tpcds_2t_flat_part_clust.item
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    from tpcds_2t_flat_part_clust.store_sales,tpcds_2t_flat_part_clust.date_dim,tpcds_2t_flat_part_clust.store,tpcds_2t_flat_part_clust.household_demographics,tpcds_2t_flat_part_clust.customer_address 
    ...
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,ca_city) dn,tpcds_2t_flat_part_clust.customer,tpcds_2t_flat_part_clust.customer_address current_addr
...
from
   tpcds_2t_flat_part_clust.web_sales
  ,tpcds_2t_flat_part_clust.warehouse
  ,tpcds_2t_flat_part_clust.ship_mode
  ,tpcds_2t_flat_part_clust.web_site
  ,tpcds_2t_flat_part_clust.date_dim
where
...
from
   tpcds_2t_flat_part_clust.catalog_sales cs1
  ,tpcds_2t_flat_part_clust.date_dim
  ,tpcds_2t_flat_part_clust.customer_address
  ,tpcds_2t_flat_part_clust.call_center
where
...
and exists (select *
            from tpcds_2t_flat_part_clust.catalog_sales cs2
            where cs1.cs_order_number = cs2.cs_order_number
              and cs1.cs_warehouse_sk <> cs2.cs_warehouse_sk)
and not exists(select *
               from tpcds_2t_flat_part_clust.catalog_returns cr1
...
select  
  ...
  count(*) cnt6
 from
  tpcds_2t_flat_part_clust.customer c,tpcds_2t_flat_part_clust.customer_address ca,tpcds_2t_flat_part_clust.customer_demographics
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Bottineau County','Marion County','Randolph County','Providence County','Sagadahoc County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from tpcds_2t_flat_part_clust.store_sales,tpcds_2t_flat_part_clust.date_dim
          where c.c_customer_sk = ss_customer_sk and
                ss_sold_date_sk = d_date_sk and
                d_year = 2000 and
                d_moy between 1 and 1+3) and
   (exists (select *
            from tpcds_2t_flat_part_clust.web_sales,tpcds_2t_flat_part_clust.date_dim
            where c.c_customer_sk = ws_bill_customer_sk and
                  ws_sold_date_sk = d_date_sk and
                  d_year = 2000 and
                  d_moy between 1 ANd 1+3) or 
    exists (select * 
            from tpcds_2t_flat_part_clust.catalog_sales,tpcds_2t_flat_part_clust.date_dim
...
with wss as 
 ...
 (select s_store_name s_store_name1,wss.d_week_seq d_week_seq1
  ...
  from wss,tpcds_2t_flat_part_clust.store,tpcds_2t_flat_part_clust.date_dim d
...
select  i_item_id
       ,i_item_desc
       ,i_current_price
 from tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.inventory, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.catalog_sales
...
select  substr(r_reason_desc,1,20)
       ...
       ,avg(wr_fee)
 from tpcds_2t_flat_part_clust.web_sales, tpcds_2t_flat_part_clust.web_returns, tpcds_2t_flat_part_clust.web_page, tpcds_2t_flat_part_clust.customer_demographics cd1,
      tpcds_2t_flat_part_clust.customer_demographics cd2, tpcds_2t_flat_part_clust.customer_address, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.reason 
             ...
             ( select s_state
               from  (select s_state as s_state,
 			    rank() over ( partition by s_state order by sum(ss_net_profit) desc) as ranking
                      from   tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.store, tpcds_2t_flat_part_clust.date_dim
...
with customer_total_return as
 ...
 from tpcds_2t_flat_part_clust.catalog_returns
     ,tpcds_2t_flat_part_clust.date_dim
     ,tpcds_2t_flat_part_clust.customer_address
...
select   
 ...
 from (
     ...
     from
         ...
         ,tpcds_2t_flat_part_clust.warehouse
         ,tpcds_2t_flat_part_clust.date_dim
         ,tpcds_2t_flat_part_clust.time_dim
 	  ,tpcds_2t_flat_part_clust.ship_mode
     where
...
select  cast(amc as numeric) / cast(pmc as numeric) am_pm_ratio
 from ( select count(*) amc
       from tpcds_2t_flat_part_clust.web_sales, tpcds_2t_flat_part_clust.household_demographics , tpcds_2t_flat_part_clust.time_dim, tpcds_2t_flat_part_clust.web_page
...
with v1 as(
 ...
 from tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store
...
(select ws1.ws_order_number,ws1.ws_warehouse_sk wh1,ws2.ws_warehouse_sk wh2
 from tpcds_2t_flat_part_clust.web_sales ws1,tpcds_2t_flat_part_clust.web_sales ws2
 where ws1.ws_order_number = ws2.ws_order_number
   and ws1.ws_warehouse_sk <> ws2.ws_warehouse_sk)
 select  
   count(distinct ws_order_number) as order_count
...
and ws1.ws_order_number in (select wr_order_number
                            from tpcds_2t_flat_part_clust.web_returns,ws_wh
...
select  dt.d_year 
 ...
 from  tpcds_2t_flat_part_clust.date_dim dt 
      ,tpcds_2t_flat_part_clust.store_sales
      ,tpcds_2t_flat_part_clust.item
...
select  channel, item, return_ratio, return_rank, currency_rank from
 ...
 from (
 	...
 	(	select ws.ws_item_sk as item
 		...
 		from 
 		 tpcds_2t_flat_part_clust.web_sales ws left outer join tpcds_2t_flat_part_clust.web_returns wr 
 ...
 from (
 	...
 	(	select 
 		...
 		from 
 		tpcds_2t_flat_part_clust.catalog_sales cs left outer join tpcds_2t_flat_part_clust.catalog_returns cr
 ...
 from (
 	...
 	(	select sts.ss_item_sk as item
 		...
 		from 
 		tpcds_2t_flat_part_clust.store_sales sts left outer join tpcds_2t_flat_part_clust.store_returns sr
...
from tpcds_2t_flat_part_clust.reason
where r_reason_sk = 1
;
...
with ss as
 ...
 from tpcds_2t_flat_part_clust.store_sales,tpcds_2t_flat_part_clust.date_dim,tpcds_2t_flat_part_clust.customer_address
 where ss_sold_date_sk = d_date_sk
  and ss_addr_sk=ca_address_sk
 group by ca_county,d_qoy, d_year),
 ws as
 (select ca_county,d_qoy, d_year,sum(ws_ext_sales_price) as web_sales
 from tpcds_2t_flat_part_clust.web_sales,tpcds_2t_flat_part_clust.date_dim,tpcds_2t_flat_part_clust.customer_address
 where ws_sold_date_sk = d_date_sk
  and ws_bill_addr_sk=ca_address_sk
 group by ca_county,d_qoy, d_year)
 select 
...
with year_total as (
 select c_customer_id customer_id
       ...
       ,'s' sale_type
 from tpcds_2t_flat_part_clust.customer
     ,tpcds_2t_flat_part_clust.store_sales
     ,tpcds_2t_flat_part_clust.date_dim
...
select  ss_customer_sk
      ...
      from (select ss_item_sk
            ...
            from tpcds_2t_flat_part_clust.store_sales left outer join tpcds_2t_flat_part_clust.store_returns on (sr_item_sk = ss_item_sk
                                                               and sr_ticket_number = ss_ticket_number)
                ,tpcds_2t_flat_part_clust.reason
...
select  count(*) from (
    ...
    from tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.customer
          where store_sales.ss_sold_date_sk = date_dim.d_date_sk
      and store_sales.ss_customer_sk = customer.c_customer_sk
      and d_month_seq between 1212 and 1212 + 11
  intersect distinct
    select distinct c_last_name, c_first_name, d_date
    from tpcds_2t_flat_part_clust.catalog_sales, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.customer
          where catalog_sales.cs_sold_date_sk = date_dim.d_date_sk
      and catalog_sales.cs_bill_customer_sk = customer.c_customer_sk
      and d_month_seq between 1212 and 1212 + 11
  intersect distinct
    select distinct c_last_name, c_first_name, d_date
    from tpcds_2t_flat_part_clust.web_sales, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.customer
...
select  a.ca_state state, count(*) cnt
 from tpcds_2t_flat_part_clust.customer_address a
     ,tpcds_2t_flat_part_clust.customer c
     ,tpcds_2t_flat_part_clust.store_sales s
     ,tpcds_2t_flat_part_clust.date_dim d
     ,tpcds_2t_flat_part_clust.item i
 where       a.ca_address_sk = c.c_current_addr_sk
 	...
 	and d.d_month_seq = 
 	     (select distinct (d_month_seq)
 	      from tpcds_2t_flat_part_clust.date_dim
               where d_year = 1998
 	        and d_moy = 6 )
 	and i.i_current_price > 1.2 * 
             (select avg(j.i_current_price) 
 	     from tpcds_2t_flat_part_clust.item j 
...
select  distinct(i_product_name)
 from tpcds_2t_flat_part_clust.item i1
...
select  s_store_name
 ...
 from tpcds_2t_flat_part_clust.store_sales
     ...
     from (
      ...
      FROM tpcds_2t_flat_part_clust.customer_address
     ...
     intersect distinct
      ...
      from (SELECT substr(ca_zip,1,5) ca_zip,count(*) cnt
            FROM tpcds_2t_flat_part_clust.customer_address, tpcds_2t_flat_part_clust.customer
...
from
 ...
 from tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.household_demographics , tpcds_2t_flat_part_clust.time_dim, tpcds_2t_flat_part_clust.store
 where ss_sold_time_sk = time_dim.t_time_sk   
     and ss_hdemo_sk = household_demographics.hd_demo_sk 
     and ss_store_sk = s_store_sk
     and time_dim.t_hour = 8
...
select  i_item_id
       ,i_item_desc
       ,i_current_price
 from tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.inventory, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store_sales
...
with  cross_items as
 ...
 from tpcds_2t_flat_part_clust.store_sales
     ,tpcds_2t_flat_part_clust.item iss
     ,tpcds_2t_flat_part_clust.date_dim d1
 ...
 select ics.i_brand_id
     ...
     ,ics.i_category_id
 from tpcds_2t_flat_part_clust.catalog_sales
     ,tpcds_2t_flat_part_clust.item ics
     ,tpcds_2t_flat_part_clust.date_dim d2
 ...
 select iws.i_brand_id
     ...
     ,iws.i_category_id
 from tpcds_2t_flat_part_clust.web_sales
     ,tpcds_2t_flat_part_clust.item iws
     ,tpcds_2t_flat_part_clust.date_dim d3
 ...
 select i_category, i_brand,
        ...
        rank() over
          (partition by i_category, i_brand,
                     cc_name
           order by d_year, d_moy) rn
 from tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.catalog_sales, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.call_center
...
select 
	...
	i_wholesale_cost,
	i_brand
 from tpcds_2t_flat_part_clust.store, tpcds_2t_flat_part_clust.item,
...
select i_brand_id brand_id, i_brand brand,t_hour,t_minute,
 ...
 from tpcds_2t_flat_part_clust.item, (select ws_ext_sales_price as ext_price, 
                 ...
                 where d_date_sk = ss_sold_date_sk
                   and d_moy=12
                   and d_year=2002
                 ) tmp,tpcds_2t_flat_part_clust.time_dim
 where
...
select c_last_name
   ...
   (select ss_ticket_number
          ,ss_customer_sk
          ,count(*) cnt
    from tpcds_2t_flat_part_clust.store_sales,tpcds_2t_flat_part_clust.date_dim,tpcds_2t_flat_part_clust.store,tpcds_2t_flat_part_clust.household_demographics
    where store_sales.ss_sold_date_sk = date_dim.d_date_sk
    and store_sales.ss_store_sk = store.s_store_sk  
    and store_sales.ss_hdemo_sk = household_demographics.hd_demo_sk
    ...
    group by ss_ticket_number,ss_customer_sk) dn,tpcds_2t_flat_part_clust.customer
    where ss_customer_sk = c_customer_sk
...
select sum (ss_quantity)
 from tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.store, tpcds_2t_flat_part_clust.customer_demographics, tpcds_2t_flat_part_clust.customer_address, tpcds_2t_flat_part_clust.date_dim
...
with customer_total_return as
 ...
 from tpcds_2t_flat_part_clust.web_returns
     ,tpcds_2t_flat_part_clust.date_dim
     ,tpcds_2t_flat_part_clust.customer_address
...
and d_date between date(2002, 08, 18)
 ...
 from tpcds_2t_flat_part_clust.web_sales,
      tpcds_2t_flat_part_clust.date_dim,
      tpcds_2t_flat_part_clust.web_page
 where ws_sold_date_sk = d_date_sk
 and d_date between date(2002, 08, 18)
             and date_add(date '2002-08-18', interval 30 day)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    group by ss_ticket_number,ss_customer_sk) dj, tpcds_2t_flat_part_clust.customer
    where ss_customer_sk = c_customer_sk
...
select  c_customer_id as customer_id
 ...
 from tpcds_2t_flat_part_clust.customer
     ...
     ,tpcds_2t_flat_part_clust.customer_demographics
     ,tpcds_2t_flat_part_clust.household_demographics
     ,tpcds_2t_flat_part_clust.income_band
     ,tpcds_2t_flat_part_clust.store_returns
...
with my_customers as (
 ...
 where  c_current_addr_sk = ca_address_sk
        ...
        and d_month_seq between (select distinct d_month_seq+1
                                 from   tpcds_2t_flat_part_clust.date_dim where d_year = 1999 and d_moy = 4)
...
select  i_brand_id brand_id, i_brand brand,
 	sum(ss_ext_sales_price) ext_price
 from tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.item
 where d_date_sk = ss_sold_date_sk
 	and ss_item_sk = i_item_sk
 	and i_manager_id=76
 	and d_moy=12
...
with wscs as
 ...
 (select wswscs.d_week_seq d_week_seq1
  ...
  from wswscs,tpcds_2t_flat_part_clust.date_dim 
...
select  i_item_id, 
 ...
 from tpcds_2t_flat_part_clust.catalog_sales, tpcds_2t_flat_part_clust.customer_demographics, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.promotion
...
select  
 ...
 from
   tpcds_2t_flat_part_clust.catalog_sales left outer join tpcds_2t_flat_part_clust.catalog_returns on
...
select  i_item_desc
      ...
      ,count(*) total_cnt
from tpcds_2t_flat_part_clust.catalog_sales
join tpcds_2t_flat_part_clust.inventory on (cs_item_sk = inv_item_sk)
join tpcds_2t_flat_part_clust.warehouse on (w_warehouse_sk=inv_warehouse_sk)
join tpcds_2t_flat_part_clust.item on (i_item_sk = cs_item_sk)
join tpcds_2t_flat_part_clust.customer_demographics on (cs_bill_cdemo_sk = cd_demo_sk)
join tpcds_2t_flat_part_clust.household_demographics on (cs_bill_hdemo_sk = hd_demo_sk)
join tpcds_2t_flat_part_clust.date_dim d1 on (cs_sold_date_sk = d1.d_date_sk)
join tpcds_2t_flat_part_clust.date_dim d2 on (inv_date_sk = d2.d_date_sk)
join tpcds_2t_flat_part_clust.date_dim d3 on (cs_ship_date_sk = d3.d_date_sk)
left outer join tpcds_2t_flat_part_clust.promotion on (cs_promo_sk=p_promo_sk)
left outer join tpcds_2t_flat_part_clust.catalog_returns on (cr_item_sk = cs_item_sk and cr_order_number = cs_order_number)
...
select 
  ...
  from
   (select ss_ticket_number
    ...
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,store.s_city) ms, tpcds_2t_flat_part_clust.customer
    where ss_customer_sk = c_customer_sk
...
select  i_item_id,
 ...
 from tpcds_2t_flat_part_clust.catalog_sales, tpcds_2t_flat_part_clust.customer_demographics cd1, 
      tpcds_2t_flat_part_clust.customer_demographics cd2, tpcds_2t_flat_part_clust.customer, tpcds_2t_flat_part_clust.customer_address, tpcds_2t_flat_part_clust.date_dim, tpcds_2t_flat_part_clust.item
 where cs_sold_date_sk = d_date_sk and
       cs_item_sk = i_item_sk and
...
select  c_last_name
 ...
 from (select ss_ticket_number
      ...
      ,tpcds_2t_flat_part_clust.customer
      ,tpcds_2t_flat_part_clust.customer_address current_addr
 where ss_customer_sk = c_customer_sk
   and customer.c_current_addr_sk = current_addr.ca_address_sk
   and current_addr.ca_city <> bought_city
 order by c_last_name
...
with ssr as
 ...
 from
  ( select  ws_web_site_sk as wsr_web_site_sk,
    ...
    from tpcds_2t_flat_part_clust.web_returns left outer join tpcds_2t_flat_part_clust.web_sales on
...
select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) sales_cnt, SUM(ext_sales_price) sales_amt FROM (
        SELECT 'store' as channel, 'ss_addr_sk' col_name, d_year, d_qoy, i_category, ss_ext_sales_price ext_sales_price
         FROM tpcds_2t_flat_part_clust.store_sales, tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.date_dim
         WHERE ss_addr_sk IS NULL
           AND ss_sold_date_sk=d_date_sk
           AND ss_item_sk=i_item_sk
        UNION ALL
        SELECT 'web' as channel, 'ws_web_page_sk' col_name, d_year, d_qoy, i_category, ws_ext_sales_price ext_sales_price
         FROM tpcds_2t_flat_part_clust.web_sales, tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.date_dim
         WHERE ws_web_page_sk IS NULL
           AND ws_sold_date_sk=d_date_sk
           AND ws_item_sk=i_item_sk
        UNION ALL
        SELECT 'catalog' as channel, 'cs_ship_mode_sk' col_name, d_year, d_qoy, i_category, cs_ext_sales_price ext_sales_price
         FROM tpcds_2t_flat_part_clust.catalog_sales, tpcds_2t_flat_part_clust.item, tpcds_2t_flat_part_clust.date_dim
