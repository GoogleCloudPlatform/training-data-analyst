...
gcloud storage objects update gs://$BUCKET/unstructured/photos/* --add-acl-grant=all-users=READER

# this allows you to look at the .py file in a browser
gcloud storage objects update gs://$BUCKET/unstructured/*.py --content-type="text/plain"
