...
TOP_K = 20000 # Limit on the number of features (vocabulary size)
MAX_SEQUENCE_LENGTH = 50 #Sentences longer than this will be truncated
SEED = 123 # Numpy random number seed
