...
def linear_model(hparams):
    ...
    model.add(
        tf.keras.layers.InputLayer(input_shape=[HEIGHT, WIDTH, 1],
                                   name="image"))
...
def train_and_evaluate(output_dir, hparams):
    ...
    train_input_fn = tf.estimator.inputs.numpy_input_fn(x={"image": x_train},
                                                        y=y_train,
                                                        batch_size=100,
                                                        num_epochs=None,
                                                        shuffle=True,
    ...
    eval_input_fn = tf.estimator.inputs.numpy_input_fn(x={"image": x_test},
                                                       y=y_test,
                                                       batch_size=100,
                                                       num_epochs=1,
                                                       shuffle=False,
