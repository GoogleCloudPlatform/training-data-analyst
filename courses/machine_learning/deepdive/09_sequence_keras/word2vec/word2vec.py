...
flags.DEFINE_string("save_path", None, "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string(
    "train_data", None, "Training text file. "
...
flags.DEFINE_integer(
    "batch_size", 16, "Number of training examples processed per step "
    "(size of a minibatch).")
flags.DEFINE_integer("concurrent_steps", 12,
                     "The number of concurrent training steps.")
flags.DEFINE_integer(
    "window_size", 5, "The number of words to predict to the left and right "
    "of the target word.")
flags.DEFINE_integer(
    "min_count", 5, "The minimum number of word occurrences for it to be "
...
class Word2Vec(object):
    ...
    def forward(self, examples, labels):
        ...
        emb = tf.Variable(tf.random_uniform([opts.vocab_size, opts.emb_dim],
    ...
    def save_vocab(self):
        ...
        np.savetxt(os.path.join(opts.save_path, "vectors.txt"),
                   self._nemb.eval())
