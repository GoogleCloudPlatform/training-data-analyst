...
# PROJECT = 'qwiklabs-gcp-27624d61500a71dc' # REPLACE WITH YOUR PROJECT ID
# BUCKET = 'collaborative_filtering_labs' # REPLACE WITH YOUR BUCKET NAME
...
CSV_COLUMNS += FACTOR_COLUMNS
LABEL_COLUMN = 'next_content_id'

# Set default values for each CSV column
DEFAULTS = [["Unknown"],["Unknown"],["Unknown"],["Unknown"],["Unknown"],["Unknown"],[mean_months_since_epoch]]
FACTOR_DEFAULTS = [[0.0] for i in range(10)]
DEFAULTS += FACTOR_DEFAULTS + FACTOR_DEFAULTS # user and item
