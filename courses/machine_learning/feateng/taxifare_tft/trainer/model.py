...
INPUT_COLUMNS = [
    ...
    tf.feature_column.categorical_column_with_identity(
        'dayofweek', num_buckets=100),  # some large number
...
def make_serving_input_fn(args):
    ...
    def _input_fn():
        ...
        feature_placeholders = {
            ...
            for column_name in
            'pickuplon,pickuplat,dropofflat,dropofflon'.split(',')
        }
