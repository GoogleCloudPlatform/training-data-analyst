...
def read_dataset_frame(file_pattern, mode, batch_size):
    def _input_fn():
        ...
        print("read_dataset_frame: _input_fn: contexts = {}".format(
            contexts))  # shape = video_id = (), labels = SparseTensor object
        print(
            "read_dataset_frame: _input_fn: features = {}".format(features)
        ...
        print("read_dataset_frame: _input_fn: decoded_rgb = {}".format(
            decoded_rgb))
        rgb_matrix = resize_axis(
            tensor=dequantize(decoded_rgb), axis=0,
            new_size=MAX_FRAMES)  # shape = (MAX_FRAMES, 1024)
        print("read_dataset_frame: _input_fn: rgb_matrix = {}".format(
            rgb_matrix))
        ...
        print("read_dataset_frame: _input_fn: decoded_audio = {}".format(
            decoded_audio))
        audio_matrix = resize_axis(
            tensor=dequantize(decoded_audio), axis=0,
            new_size=MAX_FRAMES)  # shape = (MAX_FRAMES, 128)
        print("read_dataset_frame: _input_fn: audio_matrix = {}".format(
            audio_matrix))
        ...
        print(
            "read_dataset_frame: _input_fn: features = {}".format(features)
        )  # shape = video_id = (), rgb = (MAX_FRAMES, 1024), audio = (MAX_FRAMES, 128), labels = (NUM_CLASSES,)
        ...
        print(
            "read_dataset_frame: _input_fn: batch_features = {}".format(
                batch_features)
        )  # shape = video_id = (batch_size,), rgb = (batch_size, MAX_FRAMES, 1024), audio = (batch_size, MAX_FRAMES, 128), labels = (batch_size, NUM_CLASSES)
