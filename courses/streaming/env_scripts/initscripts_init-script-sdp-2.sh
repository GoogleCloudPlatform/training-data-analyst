...
#
  gsutil cp gs://cloud-training/gcpdei/project_env.sh /training/.
  gsutil cp gs://cloud-training/gcpdei/sensor_magic.sh /training/.
  source /training/project_env.sh
  chmod +x /training/sensor_magic.sh
  chmod +x /training/project_env.sh
