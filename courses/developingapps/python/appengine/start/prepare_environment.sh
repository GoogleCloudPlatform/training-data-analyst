...
gcloud beta functions deploy process-feedback --runtime python37 --trigger-topic feedback --source ./function --stage-bucket $GCLOUD_BUCKET --entry-point subscribe
