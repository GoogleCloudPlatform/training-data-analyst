...
gcloud beta functions deploy process-feedback --runtime nodejs22 --trigger-topic feedback --source ./function --stage-bucket $GCLOUD_BUCKET --entry-point subscribe
