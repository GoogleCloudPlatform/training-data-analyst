...
gcloud functions deploy process-feedback --gen2 --runtime nodejs20 --region us-central1 --trigger-topic feedback --source ./function --stage-bucket $GCLOUD_BUCKET --entry-point subscribe --allow-unauthenticated
