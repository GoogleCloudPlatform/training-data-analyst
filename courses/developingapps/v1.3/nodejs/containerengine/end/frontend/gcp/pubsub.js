...
function registerAnswerNotification(cb) {
    ...
    answersTopic.createSubscription('Answer-subscription', { autoAck: true }, (err, answerSubscription) => {

        if (err && err.code == 6) {
            // subscription already exists
            console.log("Answer subscription already exists");
            answerSubscription = answersTopic.subscription('answer-subscription')
        }
